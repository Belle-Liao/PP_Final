...
cmake -Bbuild &&
cmake --build build -j &&
build/tinyrenderer --mode [face|tile] obj/diablo3_pose/diablo3_pose.obj obj/floor.obj
```
...
cmake -Bbuild &&
cmake --build build -j &&
build/tinyrenderer <num_threads> --mode [face|tile] obj/diablo3_pose/diablo3_pose.obj obj/floor.obj
```
